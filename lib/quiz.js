  ...
  return [
    {
      id: "a",
      name: "A러닝화",
      keywords: ["예시키워드A-1", "예시키워드A-2", "예시키워드A-3"],
      description: "예시설명A. 이 신발을 추천하는 자세한 이유를 나중에 여기에 적습니다.",
    },
    {
      id: "b",
      name: "B러닝화",
      keywords: ["예시키워드B-1", "예시키워드B-2", "예시키워드B-3"],
      description: "예시설명B. 이 신발을 추천하는 자세한 이유를 나중에 여기에 적습니다.",
    },
    {
      id: "c",
      name: "C러닝화",
      keywords: ["예시키워드C-1", "예시키워드C-2", "예시키워드C-3"],
      description: "예시설명C. 이 신발을 추천하는 자세한 이유를 나중에 여기에 적습니다.",
    },
  ];
}
